...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Your password must contain at least 8 characters, one uppercase letter, one lowercase letter and one special character.
        /// </summary>
        ...
        /// </summary>
        public static string TAG_NOT_SUPPORTED {
            get {
                return ResourceManager.GetString("TAG_NOT_SUPPORTED", resourceCulture);
            }
        }
